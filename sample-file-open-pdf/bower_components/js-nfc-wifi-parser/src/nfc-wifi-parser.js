        ...
        case MAC_ADDRESS_ID:
          ...
          if (debug) {
            console.log('macAddressId: ' + result.macAddressId.reduce(function (a, b) {
                ...
                var test = a.toString(16) + ':' + b.toString(16);
                alert(test);
              }));
          }
          break;
...
//sample payload
var samplePayload = [16,14,0,62,16,38,0,1,1,16,69,0,11,87,76,65,78,45,56,50,67,81,90,54,16,3,0,2,0,34,16,15,0,2,0,12,16,39,0,16,52,57,53,54,52,52,53,54,56,48,51,57,48,50,54,51,16,32,0,6,-1,-1,-1,-1,-1,-1];

nfcWifiParser.parseBytes(samplePayload, function(err, result){
  console.log(result);
    alert("Logggg");
});